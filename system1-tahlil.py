...
fig.suptitle(f'System1 Warm-up analysis over. {num_of_replications} replications')
...
fig.tight_layout()
fig.show()
fig.savefig('System1 Multi server queue - Warm-up analysis - Time-Frame Approach')
