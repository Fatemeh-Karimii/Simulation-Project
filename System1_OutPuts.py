...
for replication in range(num_of_replications, num_of_replications+1):
    ...
    Y_1_W_Aksbardari = statistics.mean(W_Aksbardari_Queue_List)
    Y_1_W_Tashkil_Parvandeh = statistics.mean(W_Tashkil_Parvandeh_Queue_List)
    Y_1_W_Takmil_Parvandeh = statistics.mean(W_Takmil_Parvandeh_Queue_List)
    Y_1_L_Aksbardari = statistics.mean(L_Aksbardari_Queue_List)
    Y_1_L_Tashkil_Parvandeh = statistics.mean(L_Tashkil_Parvandeh_Queue_List)
    Y_1_L_Takmil_Parvandeh = statistics.mean(L_Takmil_Parvandeh_Queue_List)
    print("Average_W_1_Aksbardari_Queue_List : ",Y_1_W_Aksbardari)
    print("Average_W_1_Tashkil_Parvandeh_Queue_List : ",Y_1_W_Tashkil_Parvandeh)
    print("Average_W_1_Takmil_Parvandeh_Queue_List : ",Y_1_W_Takmil_Parvandeh)
    print("Average_L_1_Aksbardari_Queue_List : ",Y_1_L_Aksbardari)
    print("Average_L_1_Tashkil_Parvandeh_Queue_List : ",Y_1_L_Tashkil_Parvandeh)
    print("Average_L_1_Takmil_Parvandeh_Queue_List : ",Y_1_L_Takmil_Parvandeh)

    Var_1_W_Aksbardari = statistics.variance(W_Aksbardari_Queue_List)
    Var_1_W_Tashkil_Parvandeh = statistics.variance(W_Tashkil_Parvandeh_Queue_List)
    Var_1_W_Takmil_Parvandeh = statistics.variance(W_Takmil_Parvandeh_Queue_List)
    Var_1_L_Aksbardari = statistics.variance(L_Aksbardari_Queue_List)
    Var_1_L_Tashkil_Parvandeh = statistics.variance(L_Tashkil_Parvandeh_Queue_List)
    Var_1_L_Takmil_Parvandeh = statistics.variance(L_Takmil_Parvandeh_Queue_List)
    print("Variance_W_1_Aksbardari_Queue_List : ",Var_1_W_Aksbardari)
    print("Variance_W_1_Tashkil_Parvandeh_Queue_List : ",Var_1_W_Tashkil_Parvandeh)
    print("Variance_W_1_Takmil_Parvandeh_Queue_List : ",Var_1_W_Takmil_Parvandeh)
    print("Variance_L_1_Aksbardari_Queue_List : ",Var_1_L_Aksbardari)
    print("Variance_L_1_Tashkil_Parvandeh_Queue_List : ",Var_1_L_Tashkil_Parvandeh)
    print("Variance_L_1_Takmil_Parvandeh_Queue_List : ",Var_1_L_Takmil_Parvandeh)