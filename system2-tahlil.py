...
fig.suptitle(f'System2 Warm-up analysis over. {num_of_replications} replications')
...
fig.tight_layout()
fig.show()
fig.savefig('System2 Multi server queue - Warm-up analysis - Time-Frame Approach')
